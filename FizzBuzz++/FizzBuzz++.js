...
// Thus, when the function is called without arguments, it will return the classic 
// FizzBuzz sequence up to 100:

// [ 1, 2, "Fizz", 4, "Buzz", "Fizz", 7, ... 14, "FizzBuzz", 16, 17, ... 98, "Fizz", "Buzz" ]


// When the function is called with (up to 4) arguments, it should return a custom FizzBuzz sequence, 
// for example:

// ('Hey', 'There')      -->  [ 1, 2, "Hey", 4, "There", "Hey", ... ]
// ('Foo', 'Bar', 2, 3)  -->  [ 1, "Foo", "Bar", "Foo", 5, "FooBar", 7, ... ]

var fizzBuzzCustom = function(stringOne, stringTwo, numberOne, numberTwo) {
